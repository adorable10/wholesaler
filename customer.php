...
<body>
	...
	<table width="99%" border="1" style="border-collapse:collapse; background-color:white;">
		<thead>
			<tr><th><strong>Cust_id</strong></th>
	...
	<tr><td align="center"><?php echo $row["cust_id"]; ?></td>
	<td align="center"><?php echo $row["lastname"]; ?></td>
	<td align="center"><?php echo $row["firstname"]; ?></td>
	<td align="center"><?php echo $row["middlename"]; ?></td>
	<td align="center"><?php echo $row["address"]; ?></td>
	<td align="center"><?php echo $row["number"]; ?></td>
	<td align="center"><a href="edit.cust.php?cust_id=<?php echo $row["cust_id"]; ?>">Edit</a></td>
	<td align="center"><a href="delete.cust.php?delete=<?php echo $row["cust_id"]; ?>">Delete</a></td></tr>
	<?php  } ?>
