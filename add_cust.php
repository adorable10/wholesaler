...
include('db.php');
	...
	$query = "SELECT cust_id FROM customer WHERE cust_id='$cust_id'";
	$result = mysqli_query($con, $query);
	if(mysqli_num_rows($result)>0){
		$status = "ID is already taken!";
	}else{
		$sql = "INSERT INTO customer (cust_id, lastname, firstname, middlename, address, number) VALUES ('$cust_id', '$lastname', '$firstname', '$middlename', '$address', '$number')";
...
<body>
    ...
    <div id="wrapper">
       ...
       <!-- Sidebar -->
			...
			<ul class="sidebar-nav">
				...
				<li>
					<a href="add_cust.php" title="Go to Class"><span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Add Employee</a>
				</li>
	...
	<p class="text-danger"><?php echo $status ;?></p>
		...
		<input type="text" name="cust_id" placeholder="Cust_id" required />
